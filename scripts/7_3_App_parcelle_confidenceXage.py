...
df = pd.read_csv("./data_final/tableaux/df_parcelle_filtre_dept10.csv")
...
variable_options = [
    ...
    {'label': "Probabilité d'appartenance", 'value': 'valeur'},
    {'label': 'CC', 'value': 'CC'},
    {'label': 'ENL', 'value': 'ENL'},
    {'label': 'MOCH', 'value': 'MOCH'},
    {'label': 'PAI_mean', 'value': 'PAI_GF_mean'},
    {'label': 'VCI_mean', 'value': 'VCI_mean'},
    {'label': 'Z_mean', 'value': 'Z_mean'},
    {'label': 'Densité', 'value': 'densite'},
    {'label': 'Biomass_mean', 'value': 'biomass_mean'},
